	  ...
	  return $this->operatorName;
              ...
              public function getMaterialNum(){
              	return $this->materialNum;
                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                       private $quoteItemDetailId;
                              public function setQuoteItemDetailId($quoteItemDetailId ){
                 $this->quoteItemDetailId=$quoteItemDetailId;
                 $this->apiParas["quoteItemDetailId"] = $quoteItemDetailId;
              }

              public function getQuoteItemDetailId(){
              	return $this->quoteItemDetailId;
              }
                                                                                                                                            }
